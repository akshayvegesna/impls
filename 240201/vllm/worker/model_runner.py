...
class ModelRunner:
    ...
    def __init__(
        ...
        print('model_runner.starting model runner')
    ...
    def load_model(self) -> None:
        print('model_runner.model_runner.load model')
    ...
    def _prepare_prompt(
        ...
        print('model_runner.prepare prompt')
    ...
    def prepare_input_tensors(
        ...
        seq_group_metadata_list: Optional[List[SequenceGroupMetadata]],
               ...
               Set[int], LoRAMapping]:
        print('model_runner.prepare input tensors')
    ...
    def execute_model(
        ...
        print('model_runner.execute model')
        ...
        # Execute the model.
        print('model_runner.Use cuda graph:', input_metadata.use_cuda_graph)
        if input_metadata.use_cuda_graph:
            graph_batch_size = input_tokens.shape[0]
            model_executable = self.graph_runners[graph_batch_size]
        else:
            model_executable = self.model
        print('running model executable')
    ...
    def capture_model(self, kv_caches: List[KVCache]) -> None:
        ...
        print('model_runner.capturing')
        with custom_all_reduce.capture():
            print('model_runner.capturing for batch sizes, ', batch_size_capture_list)
            for batch_size in reversed(batch_size_capture_list):
                ...
                print('model_runner.executing model')
...
class CUDAGraphRunner:
    ...
    def capture(
        ...
        print('CUDA graph runner.capture')
    ...
    def forward(
        ...
        print('CUDA graph runner.forward')
